...
@EFragment(R.layout.task_11)
public class Task_11Fragment extends Fragment {
    ...
    @AfterViews
    void ready(){
        getActivity().setTitle(R.string.task_11);
        getSpinnerData();
    }
    ...
    void getSpinnerData(){
        ...
        list_4.add(0, EMPTY);
        list_5 = DataManager.getListSpc(getContext());
        list_5.add(0, EMPTY);
        setSpinnerData();
    }
    ...
    private List<String> getData(){
        ...
        if (!input_5.getSelectedItem().toString().equalsIgnoreCase(EMPTY)) {
            data_5 = input_5.getSelectedItem().toString();
        }
        else data_5 = "";
        if (!data_1.isEmpty()) return DataManager.getDataT11(getContext(), data_1, data_2, data_3, data_4, data_5);
        return null;
    }
