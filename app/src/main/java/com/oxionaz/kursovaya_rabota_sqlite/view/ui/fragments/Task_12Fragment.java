...
@EFragment(R.layout.task_12)
public class Task_12Fragment extends Fragment {
    ...
    @AfterViews
    void ready(){
        getActivity().setTitle(R.string.task_12);
        getSpinnerData();
    }
    ...
    @Background
    void getSpinnerData(){
        list_1 = DataManager.getListWpnC(getContext());
        list_1.add(0, EMPTY);
        setSpinnerData();
    }
    ...
    private List<String> getData(){
        ...
        if (!input_1.getSelectedItem().toString().equalsIgnoreCase(EMPTY)) {
            data_1 = DataManager.getRowListWpnC(getContext(), input_1.getSelectedItemPosition() - 1);
        } else data_1 = "";
        return DataManager.getDataT12(getContext(), data_1);
    }
