...
public class BuildingFragment extends Fragment implements UpdateCallback {
    ...
    @AfterViews
    void ready(){
        getActivity().setTitle(R.string.building);
        list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                String[] row_data = DataManager.getRowBlg(getContext(), position);
                AlertDialogs.alertDialogBuilding(getContext(), row_data);
            }
        });
    }
    ...
    @Click
    void fab(){
        AlertDialogs.alertDialogBuilding(getContext(), null);
    }
            ...
            public Loader<List<String>> onCreateLoader(int id, Bundle args) {
                final AsyncTaskLoader<List<String>> loader = new AsyncTaskLoader<List<String>>(getContext()) {
                    ...
                    public List<String> loadInBackground() {
                        return DataManager.getDataBlg(getContext());
                    }
                };
                loader.forceLoad();
                return loader;
