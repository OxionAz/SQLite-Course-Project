...
@EFragment(R.layout.task_9)
public class Task_9Fragment extends Fragment {
    ...
    @AfterViews
    void ready(){
        getActivity().setTitle(R.string.task_9);
        getSpinnerData();
    }
    ...
    void getSpinnerData(){
        ...
        list_4.add(0, EMPTY);
        list_5 = DataManager.getListWpnC(getContext());
        list_5.add(0, EMPTY);
        setSpinnerData();
    }
    ...
    private List<String> getData(){
        String  data_1, data_2, data_3, data_4, data_5;
        ...
        if (!input_5.getSelectedItem().toString().equalsIgnoreCase(EMPTY)) {
            data_5 = DataManager.getRowListWpnC(getContext(), input_5.getSelectedItemPosition() - 1);
        } else data_5 = "";
        if (!data_1.isEmpty()) return DataManager.getDataT9(getContext(), data_1, data_2, data_3, data_4, data_5);
        return null;
    }
