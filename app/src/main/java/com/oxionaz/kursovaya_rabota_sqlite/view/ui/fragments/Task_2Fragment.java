...
@EFragment(R.layout.task_2)
public class Task_2Fragment extends Fragment {
    ...
    @AfterViews
    void ready(){
        getActivity().setTitle(R.string.task_2);
        getSpinnerData();
    }
    ...
    private List<String> getData(){
        ...
        if (!data_1.isEmpty()) return DataManager.getDataT2(getContext(), data_1, data_2, data_3, data_4, data_5);
        return null;
    }
