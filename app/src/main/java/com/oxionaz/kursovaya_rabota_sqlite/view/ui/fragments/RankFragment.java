...
public class RankFragment extends Fragment implements UpdateCallback {
    ...
    void ready(){
        ...
        list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                String[] row_data = DataManager.getRowRank(getContext(), position);
                AlertDialogs.alertDialogRank(getContext(), row_data);
            }
        });
    }
    ...
    @Click
    void fab(){
        AlertDialogs.alertDialogRank(getContext(), null);
    }
            ...
            public Loader<List<String>> onCreateLoader(int id, Bundle args) {
                final AsyncTaskLoader<List<String>> loader = new AsyncTaskLoader<List<String>>(getContext()) {
                    ...
                    public List<String> loadInBackground() {
                        return DataManager.getDataRank(getContext());
                    }
                };
                loader.forceLoad();
                return loader;
