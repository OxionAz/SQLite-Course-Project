...
@EFragment(R.layout.task_3)
public class Task_3Fragment extends Fragment {
    ...
    @AfterViews
    void ready(){
        getActivity().setTitle(R.string.task_3);
        getSpinnerData();
    }
    ...
    void getSpinnerData(){
        ...
        list_4.add(0, EMPTY);
        list_5 = DataManager.getListRank(getContext());
        list_5.add(0, EMPTY);
        setSpinnerData();
    }
    ...
    private List<String> getData(){
        ...
        if (!data_1.isEmpty()) return DataManager.getDataT3(getContext(), data_1, data_2, data_3, data_4, data_5);
        return null;
    }
