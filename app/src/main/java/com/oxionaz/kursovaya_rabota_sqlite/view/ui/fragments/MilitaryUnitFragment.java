...
public class MilitaryUnitFragment extends Fragment implements UpdateCallback {
    ...
    @AfterViews
    void ready(){
        getActivity().setTitle(R.string.military_unit);
        list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                String[] row_data = DataManager.getRowMU(getContext(), position);
                AlertDialogs.alertDialogMilitaryUnit(getContext(), row_data);
            }
        });
    }
    ...
    @Click
    void fab(){
        AlertDialogs.alertDialogMilitaryUnit(getContext(), null);
    }
            ...
            public Loader<List<String>> onCreateLoader(int id, Bundle args) {
                final AsyncTaskLoader<List<String>> loader = new AsyncTaskLoader<List<String>>(getContext()) {
                    ...
                    public List<String> loadInBackground() {
                        return DataManager.getDataMU(getContext());
                    }
                };
                loader.forceLoad();
                return loader;
