...
public class EquipmentCategoryFragment extends Fragment implements UpdateCallback {
    ...
    @AfterViews
    void ready(){
        getActivity().setTitle(R.string.equipment_category);
        list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                String[] row_data = DataManager.getRowEquC(position);
                AlertDialogs.alertDialogEquipmentCategory(getContext(), row_data);
            }
        });
    }
    ...
    @Click
    void fab(){
        AlertDialogs.alertDialogEquipmentCategory(getContext(), null);
    }
            ...
            public Loader<List<String>> onCreateLoader(int id, Bundle args) {
                final AsyncTaskLoader<List<String>> loader = new AsyncTaskLoader<List<String>>(getContext()) {
                    ...
                    public List<String> loadInBackground() {
                        return DataManager.getDataEquC(getContext());
                    }
                };
                loader.forceLoad();
                return loader;
