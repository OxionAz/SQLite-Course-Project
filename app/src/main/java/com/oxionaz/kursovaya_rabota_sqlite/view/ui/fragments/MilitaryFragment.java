...
public class MilitaryFragment extends Fragment implements UpdateCallback {
    ...
    @AfterViews
    void ready(){
        getActivity().setTitle(R.string.military);
        list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                String[] row_data = DataManager.getRowMilitary(getContext(), position);
                AlertDialogs.alertDialogMilitary(getContext(), row_data);
            }
        });
    }
    ...
    @Click
    void fab(){
        AlertDialogs.alertDialogMilitary(getContext(), null);
    }
            ...
            public Loader<List<String>> onCreateLoader(int id, Bundle args) {
                final AsyncTaskLoader<List<String>> loader = new AsyncTaskLoader<List<String>>(getContext()) {
                    ...
                    public List<String> loadInBackground() {
                        return DataManager.getDataMilitary(getContext());
                    }
                };
                loader.forceLoad();
                return loader;
