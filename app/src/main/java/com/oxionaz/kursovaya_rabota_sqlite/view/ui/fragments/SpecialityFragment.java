...
public class SpecialityFragment extends Fragment implements UpdateCallback {
    ...
    @AfterViews
    void ready(){
        getActivity().setTitle(R.string.speciality);
        list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                String[] row_data = DataManager.getRowSpc(position);
                AlertDialogs.alertDialogSpeciality(getContext(), row_data);
            }
        });
    }
    ...
    @Click
    void fab(){
        AlertDialogs.alertDialogSpeciality(getContext(), null);
    }
            ...
            public Loader<List<String>> onCreateLoader(int id, Bundle args) {
                final AsyncTaskLoader<List<String>> loader = new AsyncTaskLoader<List<String>>(getContext()) {
                    ...
                    public List<String> loadInBackground() {
                        return DataManager.getDataSpc(getContext());
                    }
                };
                loader.forceLoad();
                return loader;
